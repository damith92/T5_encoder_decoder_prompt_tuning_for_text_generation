...
class GPTPromptTuningMixin:
    ...
    def _cat_learned_embedding_to_input(self, input_ids):
        ...
        learned_embedding = self.transformer.drop(self.soft_prompt.weight)

        # [batch_size, n_tokens, n_embd]
        learned_embeds = learned_embedding.repeat(inputs_embeds.size(0), 1, 1)
    ...
    def forward(
        ...
        #print("soft prompt = ", self.soft_prompt.weight, "\n")
